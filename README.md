...
### Тут мы задаем трансформацию нашей модельки: сначала задаем параметры трансформации, а потом трансформируем каждую вершину нашей модельки. Далее отрисовываем по преобразованным веришнам нашу модельку. Переменная scale растет со временем, поэтому мы можем наблюдать вращение нашей модельки вокруг оси.
```c#
